...
package com.call.messaging.ui.conversation;
...
import com.call.messaging.datamodel.DataModel;
import com.call.messaging.datamodel.provider.MessagingContentProvider;
import com.call.messaging.datamodel.action.InsertNewMessageAction;
import com.call.messaging.datamodel.binding.Binding;
import com.call.messaging.datamodel.binding.BindingBase;
import com.call.messaging.datamodel.binding.ImmutableBindingRef;
...
import com.call.messaging.datamodel.data.ConversationMessageData;
import com.call.messaging.datamodel.data.ConversationParticipantsData;
import com.call.messaging.datamodel.data.DraftMessageData;
import com.call.messaging.datamodel.data.DraftMessageData.DraftMessageDataListener;
import com.call.messaging.datamodel.data.MessageData;
import com.call.messaging.datamodel.data.MessagePartData;
import com.call.messaging.datamodel.data.ParticipantData;
import com.call.messaging.datamodel.data.SubscriptionListData.SubscriptionListEntry;
import com.call.messaging.ui.AttachmentPreview;
import com.call.messaging.ui.BugleActionBarActivity;
import com.call.messaging.ui.ConversationDrawables;
import com.call.messaging.ui.SnackBar;
import com.call.messaging.ui.UIIntents;
import com.call.messaging.ui.animation.PopupTransitionAnimation;
import com.call.messaging.ui.contact.AddContactsConfirmationDialog;
import com.call.messaging.ui.conversation.ComposeMessageView.IComposeMessageViewHost;
import com.call.messaging.ui.conversation.ConversationInputManager.ConversationInputHost;
import com.call.messaging.ui.conversation.ConversationMessageView.ConversationMessageViewHost;
import com.call.messaging.ui.mediapicker.MediaPicker;
import com.call.messaging.util.AccessibilityUtil;
import com.call.messaging.util.Assert;
import com.call.messaging.util.AvatarUriUtil;
import com.call.messaging.util.ChangeDefaultSmsAppHelper;
import com.call.messaging.util.ContentType;
import com.call.messaging.util.ImeUtil;
import com.call.messaging.util.LogUtil;
import com.call.messaging.util.OsUtil;
import com.call.messaging.util.PhoneUtils;
import com.call.messaging.util.SafeAsyncTask;
import com.call.messaging.util.TextUtil;
import com.call.messaging.util.UiUtils;
