 ...
 */
package com.call.messaging.datamodel.provider;
...
import com.call.messaging.datamodel.DatabaseHelper;
import com.call.messaging.datamodel.DatabaseHelper.ConversationColumns;
import com.call.messaging.datamodel.DatabaseHelper.ConversationParticipantsColumns;
...
import com.call.messaging.widget.BugleWidgetProvider;
...
public class MessagingContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY =
            "com.call.messaging.datamodel.provider.MessagingContentProvider";
    ...
    public void setDatabaseForTest(final DatabaseWrapper db) {
        Assert.isTrue(BlockCallApplication.Companion.isRunningTests());
        mDatabaseWrapper = db;
    }
