...
import com.call.messaging.datamodel.MessageNotificationState.BundledMessageNotificationState;
import com.call.messaging.datamodel.MessageNotificationState.ConversationLineInfo;
import com.call.messaging.datamodel.MessageNotificationState.MultiConversationNotificationState;
import com.call.messaging.datamodel.MessageNotificationState.MultiMessageNotificationState;
import com.call.messaging.datamodel.action.MarkAsReadAction;
import com.call.messaging.datamodel.action.MarkAsSeenAction;
import com.call.messaging.datamodel.action.RedownloadMmsAction;
import com.call.messaging.datamodel.data.ConversationListItemData;
import com.call.messaging.datamodel.media.AvatarRequestDescriptor;
import com.call.messaging.datamodel.media.ImageResource;
import com.call.messaging.datamodel.media.MediaRequest;
import com.call.messaging.datamodel.media.MediaResourceManager;
import com.call.messaging.datamodel.media.MessagePartVideoThumbnailRequestDescriptor;
import com.call.messaging.datamodel.media.UriImageRequestDescriptor;
import com.call.messaging.datamodel.media.VideoThumbnailRequest;
import com.call.messaging.sms.MmsSmsUtils;
import com.call.messaging.sms.MmsUtils;
import com.call.messaging.ui.UIIntents;
import com.call.messaging.util.Assert;
import com.call.messaging.util.AvatarUriUtil;
import com.call.messaging.util.BugleGservices;
import com.call.messaging.util.BugleGservicesKeys;
import com.call.messaging.util.BuglePrefs;
import com.call.messaging.util.BuglePrefsKeys;
import com.call.messaging.util.ContentType;
import com.call.messaging.util.ConversationIdSet;
import com.call.messaging.util.ImageUtils;
import com.call.messaging.util.LogUtil;
import com.call.messaging.util.NotificationPlayer;
...
import com.call.messaging.util.RingtoneUtil;
import com.call.messaging.util.ThreadUtil;
import com.call.messaging.util.UriUtil;
 ...
 * 2) Failed Messages - {@link MessageNotificationState } Only one failed
...
public class BugleNotifications {
    ...
    public static void update(final boolean silent, final String conversationId,
        ...
        if (LogUtil.isLoggable(TAG, LogUtil.VERBOSE)) {
            LogUtil.e(TAG, "Update: silent = " + silent
    ...
    private static void processAndSend(final NotificationState state, final boolean silent,
        ...
        final Context context = Factory.get().getApplicationContext();
        final NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(context,context.getString(R.string.channel_general_notification_id));
...
notifBuilder.setChannelId(context.getString(R.string.channel_general_notification_id));
...
//            .setPublicVersion(null)    // TODO: when/if we ever support different
        ...
        if (notificationState instanceof MultiMessageNotificationState) {
            if (attachmentBitmap != null) {
                ...
                final NotificationCompat.Builder photoPageNotifBuilder =
                        new NotificationCompat.Builder(Factory.get().getApplicationContext(),context.getString(R.string.channel_general_notification_id));
                ...
                photoPageNotifBuilder.setChannelId(context.getString(R.string.channel_general_notification_id));
    ...
    private static synchronized void doNotify(final Notification notification,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationManager.createNotificationChannel(new NotificationChannel(Factory.get().getApplicationContext().getString(R.string.channel_general_notification_id),Factory.get().getApplicationContext().getString(R.string.channel_general_notification_name), NotificationManager.IMPORTANCE_HIGH));
        }
    ...
    public static void notifyEmergencySmsFailed(final String emergencyNumber,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context,context.getString(R.string.channel_sms_failed_id));
        builder.setTicker(line1)
                .setChannelId(context.getString(R.string.channel_sms_failed_id))
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationManager.createNotificationChannel(new NotificationChannel(context.getString(R.string.channel_sms_failed_id),context.getString(R.string.channel_sms_failed_name), NotificationManager.IMPORTANCE_HIGH));
        }
