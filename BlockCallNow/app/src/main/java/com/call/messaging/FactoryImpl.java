...
import com.call.messaging.datamodel.DataModelImpl;
import com.call.messaging.datamodel.MemoryCacheManager;
import com.call.messaging.datamodel.ParticipantRefresh.ContactContentObserver;
import com.call.messaging.datamodel.data.ParticipantData;
import com.call.messaging.datamodel.media.BugleMediaCacheManager;
import com.call.messaging.datamodel.media.MediaCacheManager;
import com.call.messaging.datamodel.media.MediaResourceManager;
import com.call.messaging.sms.BugleCarrierConfigValuesLoader;
import com.call.messaging.ui.UIIntents;
import com.call.messaging.ui.UIIntentsImpl;
import com.call.messaging.util.Assert;
import com.call.messaging.util.BugleApplicationPrefs;
import com.call.messaging.util.BugleGservices;
import com.call.messaging.util.BugleGservicesImpl;
import com.call.messaging.util.BuglePrefs;
import com.call.messaging.util.BugleSubscriptionPrefs;
import com.call.messaging.util.BugleWidgetPrefs;
import com.call.messaging.util.LogUtil;
import com.call.messaging.util.MediaUtil;
import com.call.messaging.util.MediaUtilImpl;
...
public class FactoryImpl extends Factory {
    private BlockCallApplication mApplication;
    ...
    public static Factory register(final Context applicationContext,
            final BlockCallApplication application) {
