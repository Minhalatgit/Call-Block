...
import com.call.ex.photo.provider.PhotoContract.PhotoViewColumns;
import com.call.messaging.datamodel.DatabaseHelper.MessageColumns;
import com.call.messaging.datamodel.DatabaseHelper.PartColumns;
 ...
 * {@link com.call.ex.photo.provider.PhotoContract.PhotoViewColumns}.
 */
public class ConversationImagePartsView {
    ...
    public static class Columns implements BaseColumns {
        public static final String CONVERSATION_ID = MessageColumns.CONVERSATION_ID;
        public static final String URI = PhotoViewColumns.URI;
        public static final String SENDER_FULL_NAME = PhotoViewColumns.NAME;
        public static final String CONTENT_URI = PhotoViewColumns.CONTENT_URI;
        public static final String THUMBNAIL_URI = PhotoViewColumns.THUMBNAIL_URI;
        public static final String CONTENT_TYPE = PhotoViewColumns.CONTENT_TYPE;
        // Columns in addition to those specified by PhotoContract
        public static final String DISPLAY_DESTINATION = ParticipantColumns.DISPLAY_DESTINATION;
        public static final String RECEIVED_TIMESTAMP = MessageColumns.RECEIVED_TIMESTAMP;
        public static final String STATUS = MessageColumns.STATUS;
    }
