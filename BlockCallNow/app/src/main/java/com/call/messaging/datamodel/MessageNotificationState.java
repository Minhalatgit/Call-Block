            ...
            if (messageDataCursor != null) {
                ...
                if (failedMessages.size() > 0) {
                    final NotificationCompat.Builder builder =
                            new NotificationCompat.Builder(context,context.getString(R.string.channel_sms_failed_id));
builder.setChannelId(context.getString(R.string.channel_sms_failed_name));
                    CharSequence line1;
                    CharSequence line2;
