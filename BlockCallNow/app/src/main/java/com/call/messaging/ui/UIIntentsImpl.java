...
import com.call.ex.photo.Intents.PhotoViewIntentBuilder;
import com.call.blockcallnow.R;
import com.call.messaging.datamodel.ConversationImagePartsView;
import com.call.messaging.datamodel.provider.MediaScratchFileProvider;
...
import com.call.messaging.receiver.NotificationReceiver;
import com.call.messaging.sms.MmsSmsUtils;
import com.call.messaging.ui.appsettings.ApnEditorActivity;
import com.call.messaging.ui.appsettings.ApnSettingsActivity;
import com.call.messaging.ui.appsettings.ApplicationSettingsActivity;
import com.call.messaging.ui.appsettings.PerSubscriptionSettingsActivity;
import com.call.messaging.ui.appsettings.SettingsActivity;
import com.call.messaging.ui.attachmentchooser.AttachmentChooserActivity;
import com.call.messaging.ui.conversation.ConversationActivity;
import com.call.messaging.ui.conversation.LaunchConversationActivity;
import com.call.messaging.ui.conversationlist.ArchivedConversationListActivity;
import com.call.messaging.ui.conversationlist.ConversationListActivity;
import com.call.messaging.ui.conversationlist.ForwardMessageActivity;
import com.call.messaging.ui.conversationsettings.PeopleAndOptionsActivity;
import com.call.messaging.ui.debug.DebugMmsConfigActivity;
import com.call.messaging.ui.photoviewer.BuglePhotoViewActivity;
...
public class UIIntentsImpl extends UIIntents {
    ...
    public void launchFullScreenPhotoViewer(final Activity activity, final Uri initialPhoto,
        ...
        final PhotoViewIntentBuilder builder =
                com.call.ex.photo.Intents.newPhotoViewIntentBuilder(
